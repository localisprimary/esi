...
export type GetAllianceContactsResponse = { contact_id: number; contact_type: 'character' | 'corporation' | 'alliance' | 'faction'; label_ids: number[]; standing: number }[];
...
export type GetAllianceContactsLabelsResponse = { label_id: number; label_name: string }[];
...
export type PostCharactersAffiliationResponse = { alliance_id: number; character_id: number; corporation_id: number; faction_id: number }[];
...
export type GetCharacterAgentsResearchResponse = { agent_id: number; points_per_day: number; remainder_points: number; skill_type_id: number; started_at: string }[];
...
export type PostCharacterAssetsLocationsResponse = { item_id: number; position: { x: number; y: number; z: number } }[];
...
export type PostCharacterAssetsNamesResponse = { item_id: number; name: string }[];
...
export type GetCharacterCalendarResponse = { event_date: string; event_id: number; event_response: 'declined' | 'not_responded' | 'accepted' | 'tentative'; importance: number; title: string }[];
...
export type GetCharacterCalendarEventAttendeesResponse = { character_id: number; event_response: 'declined' | 'not_responded' | 'accepted' | 'tentative' }[];
...
export interface GetCharacterClonesResponse {
  ...
  jump_clones: { implants: number[]; jump_clone_id: number; location_id: number; location_type: 'station' | 'structure'; name: string }[];
...
export type GetCharacterContactsResponse = { contact_id: number; contact_type: 'character' | 'corporation' | 'alliance' | 'faction'; is_blocked: boolean; is_watched: boolean; label_ids: number[]; standing: number }[];
...
export type GetCharacterContactsLabelsResponse = { label_id: number; label_name: string }[];
...
export type GetCharacterContractsResponse = { acceptor_id: number; assignee_id: number; availability: 'public' | 'personal' | 'corporation' | 'alliance'; buyout: number; collateral: number; contract_id: number; date_accepted: string; date_completed: string; date_expired: string; date_issued: string; days_to_complete: number; end_location_id: number; for_corporation: boolean; issuer_corporation_id: number; issuer_id: number; price: number; reward: number; start_location_id: number; status: 'outstanding' | 'in_progress' | 'finished_issuer' | 'finished_contractor' | 'finished' | 'cancelled' | 'rejected' | 'failed' | 'deleted' | 'reversed'; title: string; type: 'unknown' | 'item_exchange' | 'auction' | 'courier' | 'loan'; volume: number }[];
...
export type GetCharacterContractBidsResponse = { amount: number; bid_id: number; bidder_id: number; date_bid: string }[];
...
export type GetCharacterContractItemsResponse = { is_included: boolean; is_singleton: boolean; quantity: number; raw_quantity: number; record_id: number; type_id: number }[];
...
export type GetCharacterCorporationhistoryResponse = { corporation_id: number; is_deleted: boolean; record_id: number; start_date: string }[];
...
export interface PostCharacterFittingsParams {
  character_id: number | string;
  description: string;
  items: { flag: 'Cargo' | 'DroneBay' | 'FighterBay' | 'HiSlot0' | 'HiSlot1' | 'HiSlot2' | 'HiSlot3' | 'HiSlot4' | 'HiSlot5' | 'HiSlot6' | 'HiSlot7' | 'Invalid' | 'LoSlot0' | 'LoSlot1' | 'LoSlot2' | 'LoSlot3' | 'LoSlot4' | 'LoSlot5' | 'LoSlot6' | 'LoSlot7' | 'MedSlot0' | 'MedSlot1' | 'MedSlot2' | 'MedSlot3' | 'MedSlot4' | 'MedSlot5' | 'MedSlot6' | 'MedSlot7' | 'RigSlot0' | 'RigSlot1' | 'RigSlot2' | 'ServiceSlot0' | 'ServiceSlot1' | 'ServiceSlot2' | 'ServiceSlot3' | 'ServiceSlot4' | 'ServiceSlot5' | 'ServiceSlot6' | 'ServiceSlot7' | 'SubSystemSlot0' | 'SubSystemSlot1' | 'SubSystemSlot2' | 'SubSystemSlot3'; quantity: number; type_id: number }[];
  name: string;
  ship_type_id: number;
}
...
export type GetCharacterKillmailsRecentResponse = { killmail_hash: string; killmail_id: number }[];
...
export type GetCharacterLoyaltyPointsResponse = { corporation_id: number; loyalty_points: number }[];
...
export type GetCharacterMailResponse = { from: number; is_read: boolean; labels: number[]; mail_id: number; recipients: { recipient_id: number; recipient_type: 'alliance' | 'character' | 'corporation' | 'mailing_list' }[]; subject: string; timestamp: string }[];
...
export interface PostCharacterMailParams {
  ...
  body: string;
  recipients: { recipient_id: number; recipient_type: 'alliance' | 'character' | 'corporation' | 'mailing_list' }[];
  subject: string;
}
...
export interface GetCharacterMailLabelsResponse {
  labels?: { color: '#0000fe' | '#006634' | '#0099ff' | '#00ff33' | '#01ffff' | '#349800' | '#660066' | '#666666' | '#999999' | '#99ffff' | '#9a0000' | '#ccff9a' | '#e6e6e6' | '#fe0000' | '#ff6600' | '#ffff01' | '#ffffcd' | '#ffffff'; label_id: number; name: string; unread_count: number }[];
...
export type GetCharacterMailListsResponse = { mailing_list_id: number; name: string }[];
...
export type GetCharacterMedalsResponse = { corporation_id: number; date: string; description: string; graphics: { color: number; graphic: string; layer: number; part: number }[]; issuer_id: number; medal_id: number; reason: string; status: 'public' | 'private'; title: string }[];
...
export type GetCharacterMiningResponse = { date: string; quantity: number; solar_system_id: number; type_id: number }[];
...
export type GetCharacterNotificationsContactsResponse = { message: string; notification_id: number; send_date: string; sender_character_id: number; standing_level: number }[];
...
export type GetCharacterPlanetsResponse = { last_update: string; num_pins: number; owner_id: number; planet_id: number; planet_type: 'temperate' | 'barren' | 'oceanic' | 'ice' | 'gas' | 'lava' | 'storm' | 'plasma'; solar_system_id: number; upgrade_level: number }[];
...
export type GetCharacterStandingsResponse = { from_id: number; from_type: 'agent' | 'npc_corp' | 'faction'; standing: number }[];
...
export type GetCharacterWalletTransactionsResponse = { client_id: number; date: string; is_buy: boolean; is_personal: boolean; journal_ref_id: number; location_id: number; quantity: number; transaction_id: number; type_id: number; unit_price: number }[];
...
export type GetContractsPublicBidsResponse = { amount: number; bid_id: number; date_bid: string }[];
...
export type GetContractsPublicItemsResponse = { is_blueprint_copy: boolean; is_included: boolean; item_id: number; material_efficiency: number; quantity: number; record_id: number; runs: number; time_efficiency: number; type_id: number }[];
...
export type GetContractsPublicRegionIdResponse = { buyout: number; collateral: number; contract_id: number; date_expired: string; date_issued: string; days_to_complete: number; end_location_id: number; for_corporation: boolean; issuer_corporation_id: number; issuer_id: number; price: number; reward: number; start_location_id: number; title: string; type: 'unknown' | 'item_exchange' | 'auction' | 'courier' | 'loan'; volume: number }[];
...
export type GetCorporationCorporationMiningExtractionsResponse = { chunk_arrival_time: string; extraction_start_time: string; moon_id: number; natural_decay_time: string; structure_id: number }[];
...
export type GetCorporationCorporationMiningObserversResponse = { last_updated: string; observer_id: number; observer_type: 'structure' }[];
...
export type GetCorporationCorporationMiningObserverResponse = { character_id: number; last_updated: string; quantity: number; recorded_corporation_id: number; type_id: number }[];
...
export type GetCorporationAlliancehistoryResponse = { alliance_id: number; is_deleted: boolean; record_id: number; start_date: string }[];
...
export type PostCorporationAssetsLocationsResponse = { item_id: number; position: { x: number; y: number; z: number } }[];
...
export type PostCorporationAssetsNamesResponse = { item_id: number; name: string }[];
...
export type GetCorporationBlueprintsResponse = { item_id: number; location_flag: 'AssetSafety' | 'AutoFit' | 'Bonus' | 'Booster' | 'BoosterBay' | 'Capsule' | 'CapsuleerDeliveries' | 'Cargo' | 'CorpDeliveries' | 'CorpSAG1' | 'CorpSAG2' | 'CorpSAG3' | 'CorpSAG4' | 'CorpSAG5' | 'CorpSAG6' | 'CorpSAG7' | 'CorporationGoalDeliveries' | 'CrateLoot' | 'Deliveries' | 'DroneBay' | 'DustBattle' | 'DustDatabank' | 'ExpeditionHold' | 'FighterBay' | 'FighterTube0' | 'FighterTube1' | 'FighterTube2' | 'FighterTube3' | 'FighterTube4' | 'FleetHangar' | 'FrigateEscapeBay' | 'Hangar' | 'HangarAll' | 'HiSlot0' | 'HiSlot1' | 'HiSlot2' | 'HiSlot3' | 'HiSlot4' | 'HiSlot5' | 'HiSlot6' | 'HiSlot7' | 'HiddenModifiers' | 'Implant' | 'Impounded' | 'InfrastructureHangar' | 'JunkyardReprocessed' | 'JunkyardTrashed' | 'LoSlot0' | 'LoSlot1' | 'LoSlot2' | 'LoSlot3' | 'LoSlot4' | 'LoSlot5' | 'LoSlot6' | 'LoSlot7' | 'Locked' | 'MedSlot0' | 'MedSlot1' | 'MedSlot2' | 'MedSlot3' | 'MedSlot4' | 'MedSlot5' | 'MedSlot6' | 'MedSlot7' | 'MobileDepotHold' | 'MoonMaterialBay' | 'OfficeFolder' | 'Pilot' | 'PlanetSurface' | 'QuafeBay' | 'QuantumCoreRoom' | 'Reward' | 'RigSlot0' | 'RigSlot1' | 'RigSlot2' | 'RigSlot3' | 'RigSlot4' | 'RigSlot5' | 'RigSlot6' | 'RigSlot7' | 'SecondaryStorage' | 'ServiceSlot0' | 'ServiceSlot1' | 'ServiceSlot2' | 'ServiceSlot3' | 'ServiceSlot4' | 'ServiceSlot5' | 'ServiceSlot6' | 'ServiceSlot7' | 'ShipHangar' | 'ShipOffline' | 'Skill' | 'SkillInTraining' | 'SpecializedAmmoHold' | 'SpecializedAsteroidHold' | 'SpecializedCommandCenterHold' | 'SpecializedFuelBay' | 'SpecializedGasHold' | 'SpecializedIceHold' | 'SpecializedIndustrialShipHold' | 'SpecializedLargeShipHold' | 'SpecializedMaterialBay' | 'SpecializedMediumShipHold' | 'SpecializedMineralHold' | 'SpecializedOreHold' | 'SpecializedPlanetaryCommoditiesHold' | 'SpecializedSalvageHold' | 'SpecializedShipHold' | 'SpecializedSmallShipHold' | 'StructureActive' | 'StructureFuel' | 'StructureInactive' | 'StructureOffline' | 'SubSystemBay' | 'SubSystemSlot0' | 'SubSystemSlot1' | 'SubSystemSlot2' | 'SubSystemSlot3' | 'SubSystemSlot4' | 'SubSystemSlot5' | 'SubSystemSlot6' | 'SubSystemSlot7' | 'Unlocked' | 'Wallet' | 'Wardrobe'; location_id: number; material_efficiency: number; quantity: number; runs: number; time_efficiency: number; type_id: number }[];
...
export type GetCorporationContactsResponse = { contact_id: number; contact_type: 'character' | 'corporation' | 'alliance' | 'faction'; is_watched: boolean; label_ids: number[]; standing: number }[];
...
export type GetCorporationContactsLabelsResponse = { label_id: number; label_name: string }[];
...
export type GetCorporationContractsResponse = { acceptor_id: number; assignee_id: number; availability: 'public' | 'personal' | 'corporation' | 'alliance'; buyout: number; collateral: number; contract_id: number; date_accepted: string; date_completed: string; date_expired: string; date_issued: string; days_to_complete: number; end_location_id: number; for_corporation: boolean; issuer_corporation_id: number; issuer_id: number; price: number; reward: number; start_location_id: number; status: 'outstanding' | 'in_progress' | 'finished_issuer' | 'finished_contractor' | 'finished' | 'cancelled' | 'rejected' | 'failed' | 'deleted' | 'reversed'; title: string; type: 'unknown' | 'item_exchange' | 'auction' | 'courier' | 'loan'; volume: number }[];
...
export type GetCorporationContractBidsResponse = { amount: number; bid_id: number; bidder_id: number; date_bid: string }[];
...
export type GetCorporationContractItemsResponse = { is_included: boolean; is_singleton: boolean; quantity: number; raw_quantity: number; record_id: number; type_id: number }[];
...
export type GetCorporationFacilitiesResponse = { facility_id: number; system_id: number; type_id: number }[];
...
export type GetCorporationKillmailsRecentResponse = { killmail_hash: string; killmail_id: number }[];
...
export type GetCorporationMedalsResponse = { created_at: string; creator_id: number; description: string; medal_id: number; title: string }[];
...
export type GetCorporationMedalsIssuedResponse = { character_id: number; issued_at: string; issuer_id: number; medal_id: number; reason: string; status: 'private' | 'public' }[];
...
export type GetCorporationMembersTitlesResponse = { character_id: number; titles: number[] }[];
...
export type GetCorporationMembertrackingResponse = { base_id: number; character_id: number; location_id: number; logoff_date: string; logon_date: string; ship_type_id: number; start_date: string }[];
...
export type GetCorporationOrdersResponse = { duration: number; escrow: number; is_buy_order: boolean; issued: string; issued_by: number; location_id: number; min_volume: number; order_id: number; price: number; range: '1' | '10' | '2' | '20' | '3' | '30' | '4' | '40' | '5' | 'region' | 'solarsystem' | 'station'; region_id: number; type_id: number; volume_remain: number; volume_total: number; wallet_division: number }[];
...
export type GetCorporationOrdersHistoryResponse = { duration: number; escrow: number; is_buy_order: boolean; issued: string; issued_by: number; location_id: number; min_volume: number; order_id: number; price: number; range: '1' | '10' | '2' | '20' | '3' | '30' | '4' | '40' | '5' | 'region' | 'solarsystem' | 'station'; region_id: number; state: 'cancelled' | 'expired'; type_id: number; volume_remain: number; volume_total: number; wallet_division: number }[];
...
export type GetCorporationShareholdersResponse = { share_count: number; shareholder_id: number; shareholder_type: 'character' | 'corporation' }[];
...
export type GetCorporationStandingsResponse = { from_id: number; from_type: 'agent' | 'npc_corp' | 'faction'; standing: number }[];
...
export type GetCorporationStarbasesResponse = { moon_id: number; onlined_since: string; reinforced_until: string; starbase_id: number; state: 'offline' | 'online' | 'onlining' | 'reinforced' | 'unanchoring'; system_id: number; type_id: number; unanchor_at: string }[];
...
export type GetCorporationWalletsResponse = { balance: number; division: number }[];
...
export type GetCorporationWalletsDivisionJournalResponse = { amount: number; balance: number; context_id: number; context_id_type: 'structure_id' | 'station_id' | 'market_transaction_id' | 'character_id' | 'corporation_id' | 'alliance_id' | 'eve_system' | 'industry_job_id' | 'contract_id' | 'planet_id' | 'system_id' | 'type_id'; date: string; description: string; first_party_id: number; id: number; reason: string; ref_type: 'acceleration_gate_fee' | 'advertisement_listing_fee' | 'agent_donation' | 'agent_location_services' | 'agent_miscellaneous' | 'agent_mission_collateral_paid' | 'agent_mission_collateral_refunded' | 'agent_mission_reward' | 'agent_mission_reward_corporation_tax' | 'agent_mission_time_bonus_reward' | 'agent_mission_time_bonus_reward_corporation_tax' | 'agent_security_services' | 'agent_services_rendered' | 'agents_preward' | 'air_career_program_reward' | 'alliance_maintainance_fee' | 'alliance_registration_fee' | 'allignment_based_gate_toll' | 'asset_safety_recovery_tax' | 'bounty' | 'bounty_prize' | 'bounty_prize_corporation_tax' | 'bounty_prizes' | 'bounty_reimbursement' | 'bounty_surcharge' | 'brokers_fee' | 'clone_activation' | 'clone_transfer' | 'contraband_fine' | 'contract_auction_bid' | 'contract_auction_bid_corp' | 'contract_auction_bid_refund' | 'contract_auction_sold' | 'contract_brokers_fee' | 'contract_brokers_fee_corp' | 'contract_collateral' | 'contract_collateral_deposited_corp' | 'contract_collateral_payout' | 'contract_collateral_refund' | 'contract_deposit' | 'contract_deposit_corp' | 'contract_deposit_refund' | 'contract_deposit_sales_tax' | 'contract_price' | 'contract_price_payment_corp' | 'contract_reversal' | 'contract_reward' | 'contract_reward_deposited' | 'contract_reward_deposited_corp' | 'contract_reward_refund' | 'contract_sales_tax' | 'copying' | 'corporate_reward_payout' | 'corporate_reward_tax' | 'corporation_account_withdrawal' | 'corporation_bulk_payment' | 'corporation_dividend_payment' | 'corporation_liquidation' | 'corporation_logo_change_cost' | 'corporation_payment' | 'corporation_registration_fee' | 'cosmetic_market_component_item_purchase' | 'cosmetic_market_skin_purchase' | 'cosmetic_market_skin_sale' | 'cosmetic_market_skin_sale_broker_fee' | 'cosmetic_market_skin_sale_tax' | 'cosmetic_market_skin_transaction' | 'courier_mission_escrow' | 'cspa' | 'cspaofflinerefund' | 'daily_challenge_reward' | 'daily_goal_payouts' | 'daily_goal_payouts_tax' | 'datacore_fee' | 'dna_modification_fee' | 'docking_fee' | 'duel_wager_escrow' | 'duel_wager_payment' | 'duel_wager_refund' | 'ess_escrow_transfer' | 'external_trade_delivery' | 'external_trade_freeze' | 'external_trade_thaw' | 'factory_slot_rental_fee' | 'flux_payout' | 'flux_tax' | 'flux_ticket_repayment' | 'flux_ticket_sale' | 'freelance_jobs_broadcasting_fee' | 'freelance_jobs_duration_fee' | 'freelance_jobs_escrow_refund' | 'freelance_jobs_reward' | 'freelance_jobs_reward_corporation_tax' | 'freelance_jobs_reward_escrow' | 'gm_cash_transfer' | 'gm_plex_fee_refund' | 'industry_job_tax' | 'infrastructure_hub_maintenance' | 'inheritance' | 'insurance' | 'insurgency_corruption_contribution_reward' | 'insurgency_suppression_contribution_reward' | 'item_trader_payment' | 'jump_clone_activation_fee' | 'jump_clone_installation_fee' | 'kill_right_fee' | 'lp_store' | 'manufacturing' | 'market_escrow' | 'market_fine_paid' | 'market_provider_tax' | 'market_transaction' | 'medal_creation' | 'medal_issued' | 'milestone_reward_payment' | 'mission_completion' | 'mission_cost' | 'mission_expiration' | 'mission_reward' | 'office_rental_fee' | 'operation_bonus' | 'opportunity_reward' | 'planetary_construction' | 'planetary_export_tax' | 'planetary_import_tax' | 'player_donation' | 'player_trading' | 'project_discovery_reward' | 'project_discovery_tax' | 'project_payouts' | 'reaction' | 'redeemed_isk_token' | 'release_of_impounded_property' | 'repair_bill' | 'reprocessing_tax' | 'researching_material_productivity' | 'researching_technology' | 'researching_time_productivity' | 'resource_wars_reward' | 'reverse_engineering' | 'season_challenge_reward' | 'security_processing_fee' | 'shares' | 'skill_purchase' | 'skyhook_claim_fee' | 'sovereignity_bill' | 'store_purchase' | 'store_purchase_refund' | 'structure_gate_jump' | 'transaction_tax' | 'under_construction' | 'upkeep_adjustment_fee' | 'war_ally_contract' | 'war_fee' | 'war_fee_surrender'; second_party_id: number; tax: number; tax_receiver_id: number }[];
...
export type GetCorporationWalletsDivisionTransactionsResponse = { client_id: number; date: string; is_buy: boolean; journal_ref_id: number; location_id: number; quantity: number; transaction_id: number; type_id: number; unit_price: number }[];
...
export type GetFleetMembersResponse = { character_id: number; join_time: string; role: 'fleet_commander' | 'wing_commander' | 'squad_commander' | 'squad_member'; role_name: string; ship_type_id: number; solar_system_id: number; squad_id: number; station_id: number; takes_fleet_warp: boolean; wing_id: number }[];
...
export type GetFleetWingsResponse = { id: number; name: string; squads: { id: number; name: string }[] }[];
...
export interface GetFwLeaderboardsResponse {
  kills: { active_total: { amount: number; faction_id: number }[]; last_week: { amount: number; faction_id: number }[]; yesterday: { amount: number; faction_id: number }[] };
  victory_points: { active_total: { amount: number; faction_id: number }[]; last_week: { amount: number; faction_id: number }[]; yesterday: { amount: number; faction_id: number }[] };
}
...
export interface GetFwLeaderboardsCharactersResponse {
  kills: { active_total: { amount: number; character_id: number }[]; last_week: { amount: number; character_id: number }[]; yesterday: { amount: number; character_id: number }[] };
  victory_points: { active_total: { amount: number; character_id: number }[]; last_week: { amount: number; character_id: number }[]; yesterday: { amount: number; character_id: number }[] };
}
...
export interface GetFwLeaderboardsCorporationsResponse {
  kills: { active_total: { amount: number; corporation_id: number }[]; last_week: { amount: number; corporation_id: number }[]; yesterday: { amount: number; corporation_id: number }[] };
  victory_points: { active_total: { amount: number; corporation_id: number }[]; last_week: { amount: number; corporation_id: number }[]; yesterday: { amount: number; corporation_id: number }[] };
}
...
export type GetFwStatsResponse = { faction_id: number; kills: { last_week: number; total: number; yesterday: number }; pilots: number; systems_controlled: number; victory_points: { last_week: number; total: number; yesterday: number } }[];
...
export type GetFwSystemsResponse = { contested: 'captured' | 'contested' | 'uncontested' | 'vulnerable'; occupier_faction_id: number; owner_faction_id: number; solar_system_id: number; victory_points: number; victory_points_threshold: number }[];
...
export type GetIncursionsResponse = { constellation_id: number; faction_id: number; has_boss: boolean; infested_solar_systems: number[]; influence: number; staging_solar_system_id: number; state: 'withdrawing' | 'mobilizing' | 'established'; type: string }[];
...
export type GetIndustryFacilitiesResponse = { facility_id: number; owner_id: number; region_id: number; solar_system_id: number; tax: number; type_id: number }[];
...
export type GetIndustrySystemsResponse = { cost_indices: { activity: 'copying' | 'duplicating' | 'invention' | 'manufacturing' | 'none' | 'reaction' | 'researching_material_efficiency' | 'researching_technology' | 'researching_time_efficiency' | 'reverse_engineering'; cost_index: number }[]; solar_system_id: number }[];
...
export type GetInsurancePricesResponse = { levels: { cost: number; name: string; payout: number }[]; type_id: number }[];
...
export interface GetKillmailKillmailHashResponse {
  attackers: { alliance_id: number; character_id: number; corporation_id: number; damage_done: number; faction_id: number; final_blow: boolean; security_status: number; ship_type_id: number; weapon_type_id: number }[];
  killmail_id: number;
  killmail_time: string;
  moon_id?: number;
  solar_system_id: number;
  victim: { alliance_id: number; character_id: number; corporation_id: number; damage_taken: number; faction_id: number; items: { flag: number; item_type_id: number; items: { flag: number; item_type_id: number; quantity_destroyed: number; quantity_dropped: number; singleton: number }[]; quantity_destroyed: number; quantity_dropped: number; singleton: number }[]; position: { x: number; y: number; z: number }; ship_type_id: number };
  war_id?: number;
}
...
export type GetLoyaltyCorporationOffersResponse = { ak_cost: number; isk_cost: number; lp_cost: number; offer_id: number; quantity: number; required_items: { quantity: number; type_id: number }[]; type_id: number }[];
...
export type GetMarketsPricesResponse = { adjusted_price: number; average_price: number; type_id: number }[];
...
export type GetMarketsStructureResponse = { duration: number; is_buy_order: boolean; issued: string; location_id: number; min_volume: number; order_id: number; price: number; range: 'station' | 'region' | 'solarsystem' | '1' | '2' | '3' | '4' | '5' | '10' | '20' | '30' | '40'; type_id: number; volume_remain: number; volume_total: number }[];
...
export type GetRegionHistoryResponse = { average: number; date: string; highest: number; lowest: number; order_count: number; volume: number }[];
...
export type GetRegionOrdersResponse = { duration: number; is_buy_order: boolean; issued: string; location_id: number; min_volume: number; order_id: number; price: number; range: 'station' | 'region' | 'solarsystem' | '1' | '2' | '3' | '4' | '5' | '10' | '20' | '30' | '40'; system_id: number; type_id: number; volume_remain: number; volume_total: number }[];
...
export type GetSovereigntyMapResponse = { alliance_id: number; corporation_id: number; faction_id: number; system_id: number }[];
...
export type GetSovereigntyStructuresResponse = { alliance_id: number; solar_system_id: number; structure_id: number; structure_type_id: number; vulnerability_occupancy_level: number; vulnerable_end_time: string; vulnerable_start_time: string }[];
...
export type GetUniverseAncestriesResponse = { bloodline_id: number; description: string; icon_id: number; id: number; name: string; short_description: string }[];
...
export type GetUniverseBloodlinesResponse = { bloodline_id: number; charisma: number; corporation_id: number; description: string; intelligence: number; memory: number; name: string; perception: number; race_id: number; ship_type_id: number; willpower: number }[];
...
export type GetUniverseFactionsResponse = { corporation_id: number; description: string; faction_id: number; is_unique: boolean; militia_corporation_id: number; name: string; size_factor: number; solar_system_id: number; station_count: number; station_system_count: number }[];
...
export type PostUniverseNamesResponse = { category: 'alliance' | 'character' | 'constellation' | 'corporation' | 'inventory_type' | 'region' | 'solar_system' | 'station' | 'faction'; id: number; name: string }[];
...
export type GetUniverseRacesResponse = { alliance_id: number; description: string; name: string; race_id: number }[];
...
export type GetUniverseSystemJumpsResponse = { ship_jumps: number; system_id: number }[];
...
export type GetUniverseSystemKillsResponse = { npc_kills: number; pod_kills: number; ship_kills: number; system_id: number }[];
...
export type GetWarKillmailsResponse = { killmail_hash: string; killmail_id: number }[];
